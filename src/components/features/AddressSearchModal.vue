...
// Автоматичний пошук при введенні тексту (Debounce 500мс, щоб не спамити API)
...
<template>
  <div v-if="isOpen" class="fixed inset-0 z-[2000] bg-slate-900/50 backdrop-blur-sm flex items-start justify-center p-4">
    <div class="bg-white w-full max-w-md rounded-2xl shadow-2xl mt-12 overflow-hidden flex flex-col max-h-[80vh]">
